  ...
  return (
    <section className='bottom_banner'>
      <ul className='list_container'>
        <li><img src='award-solid.svg' alt='icon garantie decenale'></img> Garantie décénale</li>
        ...
        <li><img src='helmet-safety-solid.svg' alt='icon ouvrier qualifié'></img> Ouvriers qualifié</li>
        </ul>
    </section>
  )
}
